#include "difrobot_controller/simple_controller.hpp"
                                  ...
                                  : Node(name)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/difrobot_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
