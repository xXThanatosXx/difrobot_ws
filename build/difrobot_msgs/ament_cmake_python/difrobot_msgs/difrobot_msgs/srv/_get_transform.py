...
class Metaclass_GetTransform_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('difrobot_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'difrobot_msgs.srv.GetTransform')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from difrobot_msgs.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from difrobot_msgs.srv._get_transform import GetTransform_Request as Request
    from difrobot_msgs.srv._get_transform import GetTransform_Response as Response
