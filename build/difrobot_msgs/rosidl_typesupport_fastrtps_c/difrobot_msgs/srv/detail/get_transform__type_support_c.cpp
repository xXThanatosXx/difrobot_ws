...
#include "difrobot_msgs/srv/detail/get_transform__rosidl_typesupport_fastrtps_c.h"
...
#include "difrobot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _GetTransform_Request__ros_msg_type = difrobot_msgs__srv__GetTransform_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_difrobot_msgs
size_t get_serialized_size_difrobot_msgs__srv__GetTransform_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetTransform_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_difrobot_msgs__srv__GetTransform_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_difrobot_msgs
size_t max_serialized_size_difrobot_msgs__srv__GetTransform_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = difrobot_msgs__srv__GetTransform_Request;
    is_plain =
      (
...
static size_t _GetTransform_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_difrobot_msgs__srv__GetTransform_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform_Request)() {
...
// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_difrobot_msgs
...
using _GetTransform_Response__ros_msg_type = difrobot_msgs__srv__GetTransform_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_difrobot_msgs
size_t get_serialized_size_difrobot_msgs__srv__GetTransform_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetTransform_Response__ros_msg_type * ros_message = static_cast<const _GetTransform_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_difrobot_msgs__srv__GetTransform_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_difrobot_msgs
size_t max_serialized_size_difrobot_msgs__srv__GetTransform_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = difrobot_msgs__srv__GetTransform_Response;
    is_plain =
      (
...
static size_t _GetTransform_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_difrobot_msgs__srv__GetTransform_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform_Response)() {
...
// already included above
// #include "difrobot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "difrobot_msgs/srv/get_transform.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform)() {
