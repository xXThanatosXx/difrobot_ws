...
static const _GetTransform_Request_type_support_symbol_names_t _GetTransform_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, difrobot_msgs, srv, GetTransform_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, difrobot_msgs, srv, GetTransform_Request)() {
  return &::difrobot_msgs::srv::rosidl_typesupport_c::GetTransform_Request_message_type_support_handle;
}
...
static const _GetTransform_Response_type_support_symbol_names_t _GetTransform_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, difrobot_msgs, srv, GetTransform_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, difrobot_msgs, srv, GetTransform_Response)() {
  return &::difrobot_msgs::srv::rosidl_typesupport_c::GetTransform_Response_message_type_support_handle;
}
...
static const _GetTransform_type_support_symbol_names_t _GetTransform_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, difrobot_msgs, srv, GetTransform)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, difrobot_msgs, srv, GetTransform)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, difrobot_msgs, srv, GetTransform)() {
  return &::difrobot_msgs::srv::rosidl_typesupport_c::GetTransform_service_type_support_handle;
}
