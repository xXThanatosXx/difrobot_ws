...
#include "difrobot_msgs/srv/detail/get_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const difrobot_msgs::srv::GetTransform_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  difrobot_msgs::srv::GetTransform_Request & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = difrobot_msgs::srv::GetTransform_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const difrobot_msgs::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<difrobot_msgs::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, difrobot_msgs, srv, GetTransform_Request)() {
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_difrobot_msgs
cdr_serialize(
  const difrobot_msgs::srv::GetTransform_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: transform
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  difrobot_msgs::srv::GetTransform_Response & ros_message)
{
  // Member: transform
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = difrobot_msgs::srv::GetTransform_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const difrobot_msgs::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<difrobot_msgs::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, difrobot_msgs, srv, GetTransform_Response)() {
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
{
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, difrobot_msgs, srv, GetTransform)() {
  return &difrobot_msgs::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
